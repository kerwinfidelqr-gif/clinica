...
# 1. DASHBOARD UNIFICADO (Tarjetas + Lista de historiales)
@login_required
def historial_dashboard(request):
    especialidades_principales = [
        {'nombre': 'Ginecoobstetricia', 'icono': 'fa-person-pregnant', 'color': 'bg-pink-500'},
        {'nombre': 'Pediatría', 'icono': 'fa-child', 'color': 'bg-orange-500'},
        {'nombre': 'Cirugía', 'icono': 'fa-scalpel-path', 'color': 'bg-blue-600'},
        {'nombre': 'Medicina', 'icono': 'fa-stethoscope', 'color': 'bg-teal-500'},
    ]
